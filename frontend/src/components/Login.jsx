      ...
      <div className="w-full max-w-sm mx-auto bg-white shadow-md px-8 pt-6 pb-8 mb-4">
        ...
        <div className="mt-4">
          <button
            ...
            className="w-full flex flex-wrap gap-0 items-center justify-center bg-secondary hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none "
          >
