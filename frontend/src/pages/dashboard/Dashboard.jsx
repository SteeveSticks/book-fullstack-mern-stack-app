    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(`${getBaseURL()}/api/admin`, {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`, // gets the token
    ...
    <>
      <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
        <div className="flex items-center p-8 bg-white shadow rounded-lg">
          ...
          <div>
            <span className="block text-xl font-bold">{data?.totalBooks}</span>
        ...
        <div className="flex items-center p-8 bg-white shadow rounded-lg">
          ...
          <div>
            <span className="block text-xl font-bold">${data?.totalSales}</span>
        ...
        <div className="flex items-center p-8 bg-white shadow rounded-lg">
          ...
          <div>
            <span className="block text-xl font-bold">{data?.totalOrders}</span>
      ...
      <section className="grid md:grid-cols-2 xl:grid-cols-4 xl:grid-rows-3 xl:grid-flow-col gap-6">
        ...
        <div className="flex items-center p-8 bg-white shadow rounded-lg">
          ...
          <div>
            <span className="block text-xl font-bold">139</span>
            <span className="block text-gray-500">
      ...
      <section className="text-right text-sm font-semibold text-gray-500">
